      ...
      <div class="hero_area">
        ...
        <div class="comment my-5">
            ...
            <div class="m-auto w-50">
                <h2 class="my-4" style="font-size: 22px; font-weight: 600;">All Comments</h2>
                @foreach($comments as $comment)
                <div class="m-5 bg-gray-50 p-3 rounded-3">
                <div>
                    ...
                    @foreach($reply as $rep)
                        ...
                        <div style="padding: 10px 40px; background-color: rgba(0,0,0,0.1); border-radius: 6px;" class="my-4 replyDiv">
                            <div>
                            <b>{{ $rep->name }}</b>
                            <p>{{ $rep->reply }}</p>
